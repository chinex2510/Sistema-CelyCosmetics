...
{
    internal class ClsCrearTicketVenta
    {
        ...
        //PRIPERA PARTE ESTRUCTURA DEL TICKET
        ...
        //
        //
        //SEGUNDA PARTE AGREGAR ARTICULOS

        //Metodo para agreagar articulos al ticket de venta <--- aqui van los parametros
        public void AgregaArticulo(string articulo, int cant, double precio, double importe) //<-- parametros
        {
        ...
        public class RawPrinterHelper //<---- CODIGO DE MICROSOFT 
        {
